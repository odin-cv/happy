...
const CONFIG = { // 主配置对象，包含网站所有配置项
    ...
    videoShowcase: { // 视频展示区域配置
        ...
        content: { // 视频区域内容元素配置
            ...
            title: "安渡", // 视频区域标题文字
            subtitle: "风华绝代，无缺人生，百业路远，精彩纷呈" // 视频区域副标题文字
        },
        // 背景媒体配置
    ...
    about: { // 关于我们区域配置
        ...
        subtitle2: "安渡", // 关于我们区域副标题2
        background: "#1A202C", // 关于我们区域背景色
        content: { // 关于我们区域内容配置
            text1: [ // 第一个文本区域内容数组
                "数位义士，仗剑江湖，择世外之地建“安渡”", // 第一段文字内容
    ...
    footer: { // 页脚区域配置
        ...
        sections: [ // 页脚内容区块数组
            { // 第一个页脚区块
                title: "安渡", // 区块标题
                content: "各宗各派显神通，悠客风骨震武林，但求自在随心" // 区块内容描述
            },
            { // 第二个页脚区块
                title: "加入我们", // 区块标题
                content: "加入我们，共建美好燕云" // 区块内容描述
            },
            { // 第三个页脚区块
                title: "关注我们", // 区块标题
                social: [ // 社交媒体链接数组
                    { platform: "抖音", account: "百业分部" } // 社交平台信息对象
                ]
            }
        ],
        copyright: "&copy; 2025 安渡. 保留所有权利." // 版权信息文字
    },
    ...
    // ====================================
    audio: { // 音频播放器配置
        backgroundMusic: "https://s3plus.meituan.net/opapisdk/op_ticket_1_5673241091_1763047466436_qdqqd_y85yoq.mp3", // 背景音乐文件路径，将音频上传图床，后获得的链接
    ...
    // ====================================
    typography: { // 全局字体配置
        fontFamily: "Arial, sans-serif", // 网站默认字体族可选，"YFFYT"，"Ma Shan Zheng","PING FANG ZHUI FENG","Arial, sans-serif"
